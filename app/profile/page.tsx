...
const Profile: NextPage = () => {
    ...
    // While loading, you can show a spinner or similar.
    if (loading) {
        return (
    ...
    // If no user is logged in, you might want to redirect or show a message.
    if (!user) {
        return (
            <div className="flex flex-col min-h-screen items-center justify-center bg-gray-900 text-white">
    ...
    // If the user is a DOCTOR but the API doesn't return specialization or certificate, use mock data.
