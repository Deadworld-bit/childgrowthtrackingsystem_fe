...
const initialChildren = [
    { 
        id: 1, name: "Alice Johnson", dob: "2015-05-15", gender: "Female", parentName: "John Johnson", createdDate: "2023-01-01" 
    },
    { 
        id: 2, name: "Bob Smith", dob: "2016-08-22", gender: "Male", parentName: "Jane Smith", createdDate: "2023-02-15" 
    },
    { 
        id: 3, name: "Charlie Brown", dob: "2017-12-10", gender: "Male", parentName: "Chris Brown", createdDate: "2023-03-10" 
    },
    { 
        id: 4, name: "David Lee", dob: "2014-07-25", gender: "Male", parentName: "Diana Lee", createdDate: "2022-12-20" 
    },
    { 
        id: 5, name: "Emma Davis", dob: "2015-04-30", gender: "Female", parentName: "Edward Davis", createdDate: "2023-04-18" 
    },
    { 
        id: 6, name: "Frank Wilson", dob: "2013-11-05", gender: "Male", parentName: "Fiona Wilson", createdDate: "2022-09-14" 
    },
    { 
        id: 7, name: "Grace Hall", dob: "2016-03-18", gender: "Female", parentName: "George Hall", createdDate: "2023-06-30" 
    },
    { 
        id: 8, name: "Henry Miller", dob: "2017-02-12", gender: "Male", parentName: "Hannah Miller", createdDate: "2023-07-22" 
    },
    { 
        id: 9, name: "Ivy Anderson", dob: "2014-09-28", gender: "Female", parentName: "Ian Anderson", createdDate: "2023-05-09" 
    },
    { 
        id: 10, name: "Jack Carter", dob: "2015-06-08", gender: "Male", parentName: "Jill Carter", createdDate: "2023-08-11" 
    },
];
...
export default function ChildPage() {
    ...
    const displayedChildren = filteredChildren.slice(startIndex, startIndex + USERS_PER_PAGE);
    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white">
            ...
            <main className="flex-grow px-4 md:px-8 lg:px-16">
                <h1 className="text-3xl font-bold my-6 text-left">Child Management</h1>
                    ...
                    <table className="w-full table-auto border border-gray-600 bg-[#1E1E1E] shadow-lg">
                        ...
                        <tbody className="text-white text-lg">
                            {displayedChildren.map((child, index) => (
                                <tr key={child.id} className="border-b border-gray-600 bg-[#2D2D2D] hover:bg-[#3A3A3A]">
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4">
                    <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-full max-w-md">
                        ...
                        <p className="mb-4">Are you sure you want to delete <strong>{deletingChild?.name}</strong>?</p>
                        <div className="flex justify-end gap-4">
                            <button 
