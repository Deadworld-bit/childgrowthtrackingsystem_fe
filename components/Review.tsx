...
const Review = () => {
  return (
    <section className="flex flex-col items-center bg-[#E3F2FD] py-24 text-[#2C3E50]">
      ...
      <p className="text-[#6B7280] text-center mt-4 max-w-2xl">
...
const ReviewItem = ({ name, role, image, review }: ReviewItemProps) => {
  return (
    <div className="flex flex-col items-center bg-white p-6 rounded-2xl shadow-lg max-w-md">
      ...
      <p className="mt-4 text-center text-[#2C3E50]">“{review}”</p>
    </div>
  );
};
